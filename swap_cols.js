...
// Note: endStr includes the closing tag of the grid, so we want to keep it where it is, but it starts with `        </div>\n` which is the closing tag of the grid. 
// Wait, actually, both columns end with `</div>\n          </div>\n\n`.
